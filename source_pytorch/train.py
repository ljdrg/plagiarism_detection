...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_dim', type=int, default=6, metavar='H',  
                        help='number of hidden dimensions in the model (default: 6)')  
    parser.add_argument('--output_dim', type=int, default=1, metavar='O',  
                        help='number of output dimensions in the model (default: 1)')  
